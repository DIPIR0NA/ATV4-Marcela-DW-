...
CREATE TABLE `prova` (
  `id` int NOT NULL,
  `recuperacao` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `prova_ibfk_1` FOREIGN KEY (`id`) REFERENCES `atividade` (`id`)
...
INSERT INTO `prova` VALUES (16,50);
...
-- Dump completed on 2025-07-08 20:35:21
