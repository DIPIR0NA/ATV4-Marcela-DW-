...
CREATE TABLE `trabalho` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_atividade_trabalho` FOREIGN KEY (`id`) REFERENCES `atividade` (`id`) ON DELETE CASCADE,
  CONSTRAINT `trabalho_ibfk_1` FOREIGN KEY (`id`) REFERENCES `atividade` (`id`)
...
INSERT INTO `trabalho` VALUES (14,'1'),(15,'2');
